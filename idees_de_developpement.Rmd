...
Utiliser le dictionnaire universel des (play, take) pour réduire les possibilités et lister toutes les (play, take) associées à un hand et un board 
-> pour chaque play possible, restreindre le dictionnaire à ce play, mais même comme ça la recherche peut être encore longue car plus de 1000 possibilités pour un 10 
-> soit on vérifie pour tous les takes associés si les cartes sont sur le board (all take %in% board), soit on trouve un moyen de restreindre la recherche à partir de l'info des cartes qui sont sur le board.
...
On peut aussi, pour chaque play envisagé, filtrer du board toutes les cartes ayant une valeur supérieure, et aussi faire la condition que s'il existe une carte de la même valeur on est obligé de la choisir avant d'explorer le reste. 
-> ces 2 mesures simples devraient rendre l'énumération rapide dès que le play n'est pas trop grand.
